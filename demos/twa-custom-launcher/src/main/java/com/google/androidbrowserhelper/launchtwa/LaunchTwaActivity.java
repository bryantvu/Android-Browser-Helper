...
public class LaunchTwaActivity extends Activity {
    ...
    public void launchChrome(View view) {
        initLaunch("com.android.chrome");
    }

    public void launchFirefox(View view) {
        initLaunch("org.mozilla.firefox");
    }

    public void launchEdge(View view) {
        initLaunch("com.microsoft.emmx");
    }

    public void launchHuawei(View view) {
        initLaunch("com.huawei.browser");
    }

    public void launchSamsung(View view) {
        initLaunch("com.sec.android.app.sbrowser");
    }

    public void launchBrave(View view) {
        initLaunch("com.brave.browser");
    }

    public void launchOpera(View view) {
        initLaunch("com.opera.browser");
    }

    public void launchDuck(View view) {
        initLaunch("com.duckduckgo.mobile.android");
    }

    public void launchUc(View view) {
        initLaunch("com.UCMobile.intl");
    }

    public void initLaunch(String providerPackage){
        TwaLauncher launcher = new TwaLauncher(this, providerPackage);
        launcher.launch(LAUNCH_URI);
        launchers.add(launcher);
    }
